...
const db = level(blockDBStoreLoc, {
    valueEncoding: 'json'
});
...
class Blockchain {
    ...
    addBlockData(newBlock) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            new Blockchain().getBlockHeight().then(height => {
                ...
                if (height > 0) {
                    ...
                    new Blockchain().getBlock(--height).then((Block) => {

                        newBlock.previousBlockHash = Block.hash;

                        new Blockchain().addDataToLevelDB(newBlock);
